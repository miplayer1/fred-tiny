...
<html lang="fr">
  <head>
    <title>Fred petits travaux et rénovations
    </title>  
...
?>
    <header>
      <div class="show-on-med-and-up" id="video-header">
        ...
        <video class="center" autoplay loop muted poster="http://localhost/fred-tiny/assets/poster-fred-tiny.png">
          <source src="http://localhost/fred-tiny/assets/video-bricolage.mp4" type="video/mp4" alt="Petits travaux, remise en état, bricolage">
        </video>
      </div>
      <div class="content">
        <div class="row">
          ...
          <div class="col s12 tagline">
            <h1 class="center-align white-text">
              Pas le temps ? Pas les outils ? Faites appel à Fred !
              <br>
              <br>
              <span class=" blue-grey darken-1">
                <ul>
                  <li class="display">Installer une cuisine
                  </li>
                  <li>Changer un robinet
                  </li>
                  <li>Changer un interrupteur
                  </li>
                  <li>Peindre des volets
                  </li>
                  <li>Poser une tringle
                  </li>
                  <li>Installer une salle de bain
                  </li>
                  <li>Poser un parquet
                  </li>
                  <li>Relooker une pièce
                  </li>
                  <li>Poser une terrasse en bois
                  </li>
                  <li>Poser un luminaire
                  </li>
                  <li>Changer une prise
                  </li>
                  <li>Installer un WC
                  </li>
                  <li>Poser un revêtement mural
                  </li>
                  <li>Installer un abri de jardin
                  </li>
                  <li>Et plus encore...
                  </li>
                </ul>
          ...
          <div class="col s12 social center-align">
            <span class="white-text">
              ...
              <br>J' interviens sur
              <br>Ceyreste, La Ciotat, Aubagne et alentours
            </span>
          </div>
        </div>
        <div class="col s12 center-align">
          <a href="https://www.facebook.com/fred.renovationstravaux" target="_blank" >
            <img src="assets/logo-fb.png" alt="Suivez-nous sur Facebook">
          </a>
        </div>
        <div class="fixed-action-btn horizontal">
          <a href='tel:33684205036' class="btn-floating btn-large red">
            <i class="material-icons">&#xE325;
            </i>
          </a>
          <ul>
  ...
  <section id="section1" class="row scrollspy">
    <div class="col s12 m8 offset-m2 white-text">
      <h2 class="center-align blue-grey-text darken-1-text">Choisir n'est pas simple. Mais je peux vous aider ;)
      </h2>
    </div>
    <div class="separator col s2 offset-s5 divider">
    </div>
    <?php
...
?>
  ...
  <section id="section2" class="scrollspy blue-grey darken-1">
    <div class="container">
      <div class="row">
        <div class="col s12 m8 offset-m2 white-text">
          <h2 class="center-align white-text">C'est eux qui le disent :)
          </h2>
        </div>
        <div class="separator col s2 offset-s5 divider">
        </div>
...
?>
    ...
    <div class="container">
      <div class="row">	    
        <div class="col s12 m8 offset-m2">
          <h2 class="blue-grey-text darken-1-text center-align">Parlez-moi de votre projet
          </h2>
        </div>
        <div class="separator col s2 offset-s5 divider">
        </div>
        ...
        <form class="col s12" action="#contact" method="POST">
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <textarea placeholder="Votre message" id="message" name="message" type="text" class="materialize-textarea" required>
              </textarea>
  ...
  <footer class="page-footer blue-grey darken-1">
    <div class="container  ">
      <div class="row ">
        <div class=" col m4 s12 center-align">
          <h5 class="center-align white-text">Contacts
          </h5>
          <div class="separator col s2 offset-s5 divider">
          </div>
          <div class="col s12  center-align">
            <p class="center-align grey-text text-lighten-4">fred.travauxrenovations@gmail.com
            </p>
          </div>
          <div class="col s12 m12 center-align ">
            <p class="center-align grey-text text-lighten-4">06 12 34 31 70
            </p>
          </div>
        </div>
        <div class="center-align social col m4  s12">
          <h5 class="white-text">Réseaux sociaux 
          </h5>
          <div class="separator col s2 offset-s5 divider">
          </div>
          <div class="col  s12 center-align">
        ...
        <div class="center-align col m4 s12">
          <h5 class="white-text">Adresse
          </h5>
          <div class="separator col s2 offset-s5 divider">
          </div>
          <div class="col s12">
            <p class="grey-text text-lighten-4">Quartier des Camegiers
              <br>13600 Ceyreste
            </p>
          </div>
        </div>
    ...
    <div class="footer-copyright grey-text ">
      <div class="container ">
        <span class="white-text">CC BY-NC-SA 4.0 - 2017 /
        </span> 
        <a class="white-text" href="http://www.cooldev.xyz" target="_blank">La Team Cooldev
        </a>
        <a class="modal-trigger right white-text" href="#modal1" >Mentions légales
        </a>
        <div id="modal1" class="modal modal-fixed-footer">
          <div class="modal-content">
            ...
            <h3>Responsable de la publication :
            </h3> 
            <p>Fred xxxxxx
            </a>
          </p>
        ...
        <p>
          <a href="https://gandi.net">GANDI SAS
          </a>, Société par Actions Simplifiée au capital de 300.000€ ayant son siège social au 63-65 boulevard Massena à Paris (75013) FRANCE, immatriculée sous le numéro 423 093 459 RCS PARIS N° TVA FR81423093459 Téléphone : +33.(0) 1 70.37.76.61 .
        </p>
        <h3>Gestion des données personnelles :
        </h3>
        <p>Votre vie privée est très importante pour nous. Pour connaître le trafic sur ce site internet, Nous utilisons 
          <a href="https://piwik.org">Piwik
          </a>. Piwik est une solution d’analytics qui respecte votre vie privée conformément aux recommandations de la CNIL et ne demande aucune déclaration préalable.
        </p>
      </div>
      <div class="modal-footer ">
        <a href="#!" class="modal-action modal-close btn-floating ">
